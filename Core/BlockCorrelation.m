...
%
% Obs.: This code was made available by the authors of the article [*].
%
% [*] P. Ramírez-Espinosa, D. Morales-Jimenez and K. -K. Wong, 
% "A New Spatial Block-Correlation Model for Fluid Antenna Systems", 
% IEEE Trans. Wireless Commun., vol. 23, no. 11, 
% pp. 15829-15843, Nov. 2024, doi: 10.1109/TWC.2024.3434509.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
